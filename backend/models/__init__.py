...
if testing:
    ...
    class MockCollection:
        ...
        def stream(self):
            ...
            return [MockDocument(self.name, doc_id, data) 
    ...
    class MockDocument:
        ...
        def get(self):
            ...
            self.exists = self.id in MockDB.collections.get(self.collection_name, {})
            return self
        ...
        def update(self, data):
            ...
            if self.collection_name not in MockDB.collections or self.id not in MockDB.collections[self.collection_name]:
                return self
        ...
        def delete(self):
            ...
            if self.collection_name in MockDB.collections and self.id in MockDB.collections[self.collection_name]:
