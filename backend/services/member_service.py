...
from models.member import Member, COLLECTION_NAME
...
def create_new_member(first_name, last_name, email, phone=None, address=None, id_card_number=None):
    member = Member(
...
def update_existing_member(member, first_name=None, last_name=None, email=None, phone=None, address=None, id_card_number=None):
    if first_name:
